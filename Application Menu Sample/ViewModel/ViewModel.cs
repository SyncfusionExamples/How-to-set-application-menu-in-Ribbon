...
{
    /// <summary>
    /// Represents the behaviour code for MainWindow.xaml
    /// </summary>
    public class ViewModel : NotificationObject
    {
        ...
        /// <summary>
        /// Maintains the command for closing application menu.
        /// </summary>
        private ICommand applicationMenuCommand;
        ...
        public ViewModel()
        {
            CommonResourceDictionary = new ResourceDictionary() { Source = new Uri("/ApplicationMenu;component/Assets/Ribbon/PathIcon.xaml", UriKind.RelativeOrAbsolute) };
            CreateMiniToolBar();
            ...
            applicationMenuCommand = new DelegateCommand<object>(ExecuuteApplicationMenuCommand);
        ...
        /// <summary>
        /// Indicates whether the format is bold or not <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether the format is italic or not <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether the format is underline or not <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for closing the application menu <see cref="ViewModel"/> class.
        /// </summary>
        public ICommand ApplicationMenuCommand
        {
            get
            {
        ...
        /// <summary>
        /// Method to close the application menu.
        /// </summary>
        /// <param name="parameter">Specifies the object type parameter.</param>
        private void ExecuuteApplicationMenuCommand(object parameter)
        {
            ribbon.ApplicationMenu.IsPopupOpen = false;
        }
